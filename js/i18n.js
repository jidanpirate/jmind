...
const JmindI18n = (function () {
  ...
  const DICT = {
    zh: {
      ...
      font_family_kai: '楷体',
      font_family_mono: '等宽',
      toast_root_no_outdent: '根节点不能提升层级',
      toast_outdent_top: '已在最顶层',
      kbd_child: '子',
      kbd_sibling: '兄弟',
      kbd_delete: '删除',
      kbd_edit: '编辑',
    ...
    en: {
      ...
      font_family_song: 'SimSun',
      font_family_hei: 'SimHei',
      font_family_kai: 'KaiTi',
      font_family_mono: 'Mono',
      toast_root_no_outdent: 'Cannot outdent the root',
      toast_outdent_top: 'Already at top level',
      kbd_child: 'child',
      kbd_sibling: 'sibling',
      kbd_delete: 'del',
      kbd_edit: 'edit',
